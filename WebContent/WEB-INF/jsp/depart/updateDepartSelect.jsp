...
<body>
<form:form modelAttribute="depart"  method="post" action="depart/selectDepartCon?act=update">
	 <fieldset>
	  <legend>修改部门</legend>
        <p>
            <label>部门名:</label>
		...
		<table border="1" bordercolor="PaleGreen">
			...
			<c:forEach items="${departs }" var="depart">
				<tr onmousemove="changeColor(this)" onmouseout="changeColor1(this)">
					...
					<td><a href="depart/selectADepart?id=${depart.id }&sid=${depart.supdepartment}&act=update">修改</a></td>
				</tr>
			</c:forEach>
		</table>
	</c:if>
