...
<body>
<form:form modelAttribute="report"  method="post" action="report/reportSelect?act=new">
	 <fieldset>
	   <legend>查询新员工</legend>
         <p>
           <label>查询开始日期：</label>
	...
	<c:if test="${reportNewSatffs.size() == 0 }">
		您还没有新员工。
	</c:if>
	<c:if test="${reportNewSatffs.size() != 0 }">
		<table border="1" bordercolor="PaleGreen">
			<tr>
				...
				<th width="150px">入职日期</th>
				<th width="150px">学历</th>
			</tr>
			<c:forEach items="${reportNewSatffs }" var="map">
