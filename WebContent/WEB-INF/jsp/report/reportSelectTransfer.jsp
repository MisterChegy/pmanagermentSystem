...
<body>
<form:form modelAttribute="report"  method="post" action="report/reportSelect?act=transfer">
	 <fieldset>
	...
	<c:if test="${reportTransferSatffs.size() == 0 }">
		您还没有调动员工。
	</c:if>
	<c:if test="${reportTransferSatffs.size() != 0 }">
		<table border="1" bordercolor="PaleGreen">
			<tr>
				...
				<th width="100px">原岗位名称</th>
				<th width="100px">新岗位名称</th>
				<th width="100px">调动日期</th>
				<th width="100px">调动类型</th>
			</tr>
			<c:forEach items="${reportTransferSatffs }" var="map">
