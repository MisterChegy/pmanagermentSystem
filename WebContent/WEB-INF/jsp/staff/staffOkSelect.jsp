...
<body>
<form:form modelAttribute="staff"  method="post" action="staff/selectStaffCon?act=ok">
	 <fieldset>
	   <legend>查询已转正员工</legend>
	    <p>
           <label>试用开始日期：</label>
		...
		<table border="1" bordercolor="PaleGreen">
			...
			<c:forEach items="${staffs }" var="staff">
				<tr onmousemove="changeColor(this)" onmouseout="changeColor1(this)">
					...
					<td>${staff.status }</td>
					<td><a href="staff/selectAStaff?id=${staff.id }" target="_blank">详情</a></td>
				</tr>
			</c:forEach>
		</table>
	</c:if>
